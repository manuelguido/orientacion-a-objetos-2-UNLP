...
//	private JsonSimpleAdapter jsonAdapter = new JsonSimpleAdapter();
	private JacksonAdapter jacksonAdapter = new JacksonAdapter();

	// Exportar en ejercicio 2B2
	public String exportar(List<Socio> socios) {
//		return this.jsonAdapter.exportar(socios);
		return this.jacksonAdapter.exportar(socios);
	}
